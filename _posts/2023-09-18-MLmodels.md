...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-1">
        <div class="image-container">
            {% include figure.liquid loading="eager" path="assets/img/waml_img2.jpg" class="img-fluid rounded z-depth-1" %}
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-1">
        <div class="image-container">
            {% include figure.liquid loading="eager" path="assets/img/messyequations.jpg" class="img-fluid rounded z-depth-1" %}
        </div>
    </div>
</div> 
<br>
...
<div class="col-sm mt-3 mt-md-0">
  {% include figure.liquid 
     loading="eager" 
     path="assets/img/AIdomain.png" 
     class="img-fluid rounded z-depth-0 small-img" %}
</div>
